...
test("všechny doménové API oblasti odmítnou požadavek bez Entra tokenu",async()=>{
  ...
  const requests=[
    ...
    {method:"POST",url:"/v1/contracts/10000000-0000-4000-8000-000000000001/addenda",payload:{}},
    {method:"POST",url:"/v1/contracts/10000000-0000-4000-8000-000000000001/notes",payload:{}},
    {method:"POST",url:"/v1/contract-notes/10000000-0000-4000-8000-000000000001/archive",payload:{}},
    {method:"POST",url:"/v1/payment-obligations",payload:{}},
    {method:"POST",url:"/v1/payments/10000000-0000-4000-8000-000000000001/refunds",payload:{}},
